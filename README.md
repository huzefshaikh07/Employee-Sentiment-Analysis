...
Sentiment classification was performed using TextBlob polarity analysis.

For each email body, TextBlob generates a polarity score ranging from -1 to +1:
...
A numerical sentiment score was then assigned as follows:
...
Two additional columns were created in the dataset:
